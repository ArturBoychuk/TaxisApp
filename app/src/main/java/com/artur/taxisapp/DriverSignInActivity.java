...
public class DriverSignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggleLoginSignUpTextView = findViewById(R.id.toggleSignUpTextView);
    ...
    private boolean validateName() {
        ...
        if (nameInput.isEmpty()) {
            ...
            textInputName.setError("Length of name should be less than 15");
            return false;
        } else {
    ...
    private boolean validatePassword() {
        ...
        if (passwordInput.isEmpty()) {
            ...
            textInputPassword.setError("Length of name should be more than 7");
            return false;
        } else {
    ...
    private boolean validateConfirmPassword() {
        ...
        if (!passwordInput.equals(confirmPasswordInput)) {
            textInputPassword.setError("Passwords should match");
            return false;
        } else {
            textInputPassword.setError("");
            return true;
    ...
    public void loginSignUpUser(View view) {
        ...
        if(isLoginModeActive){
            auth.signInWithEmailAndPassword(textInputEmail.getEditText().getText().toString().trim(), textInputPassword.getEditText().getText().toString()
                    .trim())
            ...
            auth.createUserWithEmailAndPassword(textInputEmail.getEditText().getText().toString().trim(), textInputPassword.getEditText().getText().toString()
                    .trim())
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
