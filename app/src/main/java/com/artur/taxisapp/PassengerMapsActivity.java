...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    Button settingsButton, signOutButton, bookTaxiButton;
        ...
        nearestDriverLocation.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    List<Object> driverLocationParameter =
                            (List<Object>) dataSnapshot.getValue();

                    double latitude = 0;
                    double longitude = 0;

                    if (driverLocationParameter.get(0) != null) {

                        latitude = Double.parseDouble(
                                driverLocationParameter.get(0).toString());
                    }

                    if (driverLocationParameter.get(0) != null) {
                        longitude = Double.parseDouble(
                                driverLocationParameter.get(1).toString());
                    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (currentLocation != null) {
            ...
            mMap.addMarker(new MarkerOptions().position(passengerLocation).title("Marker in Sydney"));
                ...
                .addOnFailureListener(this, e -> {
                    ...
                    switch (statusCode) {
                        ...
                        case LocationSettingsStatusCodes
                            ...
                            String message =
                                    "Adjust location settings on your devise";
            ...
            case CHECK_SETTINGS_CODE:
                switch (resultCode) {
                    ...
                    case Activity.RESULT_CANCELED:
                        Log.d("MainActivity", "User hasn't agreed to change location settings");
                        isLocationUpdatesActive = false;
                        updateLocationUi();
                        break;
                }
